...
for i in $(find public/images/user -name "*.jpg" -or -name "*.png" -or -name "*.gif" -maxdepth 1 -type f)
do
...
for i in $(find public/images/news -name "*.jpg" -or -name "*.png" -or -name "*.gif" -maxdepth 1 -type f)
do
    file=$(echo $i | cut -d'/' -f4)
...
for i in $(find public/images/offer -name "*.jpg" -or -name "*.png" -or -name "*.gif" -maxdepth 1 -type f)
do
    file=$(echo $i | cut -d'/' -f4)
...
for i in $(find public/images/photo -name "*.jpg" -or -name "*.png" -or -name "*.gif" -maxdepth 1 -type f)
do
    file=$(echo $i | cut -d'/' -f4)

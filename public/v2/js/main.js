...
exports.default = {
    ...
    computed: {
        ...
        d: function d() {
            return this.generateArc(this.size / 2, this.size / 2, this.size / 2 - this.border / 2, this.startangle, this.endangle);
        }
    ...
    methods: {
        ...
        generateArc: function generateArc(x, y, radius, startAngle, endAngle) {
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<div class=\"Arc\">\n\n    <svg :style=\"{ width: size + 'px', height: size + 'px' }\">\n    \n        <path fill=\"none\" :stroke=\"color\" :stroke-width=\"border\" :d=\"d\"></path>\n  \n    </svg>\n\n</div>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-a0770a7e", module.exports)
  } else {
    hotAPI.update("_v-a0770a7e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _Arc = require('./components/Arc/Arc.vue');

var _Arc2 = _interopRequireDefault(_Arc);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var globalProps = JSON.parse(decodeURIComponent(document.querySelector('#globalprops').getAttribute('content')));

_vue2.default.use(_vueResource2.default);
_vue2.default.http.headers.common['X-CSRF-TOKEN'] = globalProps.token;
...
},{"./components/Arc/Arc.vue":5,"vue":4,"vue-resource":3}]},{},[6]);

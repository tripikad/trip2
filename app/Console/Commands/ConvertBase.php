        ...
        if ($this->isUserConvertable($user->uid)) {
          ...
          !$this->isInstagramUrl($homepage)
            ...
            : null;
                ...
                $model->contact_facebook = $this->isUrl($homepage) && $this->isFacebookUrl($homepage) ? $homepage : null;

                $model->contact_twitter = $this->isUrl($homepage) && $this->isTwitterUrl($homepage) ? $homepage : null;

                $model->contact_instagram = $this->isUrl($homepage) && $this->isInstagramUrl($homepage) ? $homepage : null;

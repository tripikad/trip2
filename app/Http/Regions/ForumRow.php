    ...
    public function render($forum, $route = '')
    {
        ...
        return component('ForumRow')
            ...
            ->with('meta', component('Meta')->with('items', collect()
                    ...
                    ->pushWhen($forum->views_count >= 25, component('Tag')
                        ->is('orange')
                        ->with('title', ($forum->views_count > 1 ? trans('content.post.views', ['number' => $forum->views_count]) : trans('content.post.view', ['number' => $forum->views_count])))
                    )

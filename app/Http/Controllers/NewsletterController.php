      ...
      $left_content->push(
        component('Meta')->with(
          ...
          collect()
            ...
            ->push(
              component('Tag')->with('title', trans('newsletter.started_at') . ' ' . format_date($sent->started_at))
            )
            ->push(
              component('Tag')->with(
                'title',
    ...
    return layout('Two')
      ...
      ->with(
        ...
        region(
          'ForumHeader',
          collect()
            ->push(component('Title')->with('title', trans('newsletter.title') . ': ' . $newsletter->subject))
            ->push(component('BlockHorizontal')->with('content', region('ForumLinks')))
        )
      )
      ->with(

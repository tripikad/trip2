                                ...
                                ->push(
                                    component('FormSelectMultiple')
                                        ...
                                        ->withValue(
                                            old(
                                                'start_destinations[]',
                                                $offer->startDestinations()->pluck('destination_id')
                                            )
                                        )
                                )
                                ->push(
                                    component('FormSelectMultiple')
                                        ...
                                        ->withValue(
                                            old(
                                                'end_destinations[]',
                                                $offer->endDestinations()->pluck('destination_id')
                                            )
                                        )
                                )
                                ->push(
                                                ...
                                                ->push(
                                                    component('FormTextfield')
                                                        ...
                                                        ->withValue(
                                                            old(
                                                                'start_at',
                                                                $offer->start_at->format(
                                                                    config('offer.date.inputformat')
                                                                )
                                                            )
                                                        )
                                                )
                                                ->push(
                                                    component('FormTextfield')
                                                        ...
                                                        ->withValue(
                                                            old(
                                                                'end_at',
                                                                $offer->end_at->format(config('offer.date.inputformat'))
                                                            )
                                                        )
                                                )
                                        )

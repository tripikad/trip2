              ...
              return collect()
                ->push(
                  component('Meta')->with(
                    'items',
                    collect()
                      ->push(component('MetaLink')->with('title', trans('user.activity.comments.row.1')))
                      ->push(
                        component('MetaLink')
                          ->is('cyan')
                          ...
                          ->with(
                            'route',
                            route($comment->content->type . '.show', [$comment->content->slug]) .
                              '#comment-' .
                              $comment->id
                          )
                      )
                      ->push(component('MetaLink')->with('title', trans('user.activity.comments.row.3')))
                      ->push(
                        component('MetaLink')
                          ->is('cyan')

        ...
        return layout('Two')
            ...
            ->with(
                ...
                region(
                    'ForumHeader',
                    collect()
                        ->push(component('Title')->with('title', trans('content.internal.index.title')))
    ...
    public function show($slug)
    {
        ...
        return layout('Two')
            ...
            ->with(
                ...
                region(
                    'ForumHeader',
                    collect()->push(component('Title')->with('title', trans('content.internal.index.title')))
                )
            )
            ...
            ->with(
                ...
                collect()
                    ...
                    ->pushWhen(
                        ...
                        region('CommentCreateForm', $forum, 'inset')
                    )
            )

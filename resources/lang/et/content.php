...
return [
    ...
    'action.add.comment' => 'Lisa kommentaar',

    'action.edit.title' => 'Muuda',

    'action.follow.1.title' => 'Jälgi',
    ...
    'action.status.1.info' => 'Postitus :title on nüüd avalik.',
    'action.status.0.info' => 'Postitus :title on nüüd peidetud.',
    ...
    'shortnews.create.title' => 'Lisa lühiuudis',

    'shortnews.edit.field.title.title' => 'Pealkiri',
    'shortnews.edit.field.title.help' => '',

    'shortnews.edit.field.body.title' => 'Sisu',
    'shortnews.edit.field.body.help' => '',

    'shortnews.edit.field.destinations.title' => 'Vali sihtkohad',
    ...
    'poll.edit.field.destination' => 'Sihtkoht',
    ...
    'poll.answer.error.save' => 'Vastamisel tekkis viga! Uuendage lehte ja proovige uuesti.',
    'poll.answer.count' => 'Vastanud kasutajaid',
    'poll.show.redirect.index' => 'Avalehele',
    'poll.show.title' => 'Tulemused',
    'poll.show.user.count' => 'Vastanud kasutajate arv: :count',
    'poll.show.user.correct' => 'Õigeid vastuseid: :correct/:all',

      ...
      return this.offers
        ...
        .filter(o => {
          if (this.activeDestination > -1) {
            return o.end_destinations[0].name == this.getById(this.destinations, this.activeDestination, 'name')
          }
          return true
        })
        .filter(o => {
        ...
        .filter(o => {
          return (
            this.convertToNumber(o.price) >= this.activePriceFrom && this.convertToNumber(o.price) <= this.activePriceTo
          )
        })
    }
  },
    ...
    if (this.route) {
      fetch(this.route)
        ...
        .then(res => {
          ...
          this.activePriceFrom = this.minPrice
          this.activePriceTo =
            this.maxPrice < this.minPrice + this.priceRange ? this.minPrice + this.priceRange : this.maxPrice
        })
    }
  }
}

  ...
  <nav class="NavbarDesktop" :class="isclasses">
    <div class="NavbarDesktop__links">
      ...
      <div v-on-clickaway="onClickaway">
        <a v-if="!user" :class="{ active: isActive }" @click="onClick">
        ...
        <div v-if="user" :class="{ active: isActive }" @click="onClick" class="NavbarDesktop__userImage">
          <component v-if="user.badge" :is="'Badge'" class="NavbarDesktop__badge" :title="user.badge"></component>

          <component :is="'UserImage'" route="javascript:;" :image="user.image" :rank="user.rank"> </component>
        </div>
      </div>

      <div class="NavbarDesktop__popover" v-show="submenuOpen" transition="fadeZoom">
        <div class="NavbarDesktop__arrowWrapper">
          <div class="NavbarDesktop__arrow"></div>
        </div>

        <div class="NavbarDesktop__sublinks">
          <a v-for="(link, index) in sublinks" :href="link.route" :key="index">
            <div class="NavbarDesktop__sublinkWrapper">
              <div class="NavbarDesktop__sublinkTitle">
                {{ link.title }}
              </div>

              <div class="NavbarDesktop__sublinkBadge" v-if="link.badge">
